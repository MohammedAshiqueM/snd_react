...
const JoinButton = ({ scheduleProps }) => {
    const { scheduledTime, id, teacherId, studentId, duration } = scheduleProps;
    ...
    useEffect(() => {
        ...
        const calculateTimeLeft = () => {
          ...
          const differenceFromEnd = endTime - now;
      
          // Allow joining 5 minutes before until session end
          const canJoinNow = difference <= 5 * 60 * 1000 && differenceFromEnd >= 0;
        ...
        {schedule.status === 'AC' && (
          <JoinButton
            scheduleProps={{
              ...
              id: schedule.id,
              duration: schedule.request.duration_minutes,
